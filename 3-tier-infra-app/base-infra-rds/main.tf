...
# resource "aws_lb_target_group" "three_tier_infra_app_api_tg" {
#   name     = "three-tier-infra-app-api-tg"
#   port     = 80
#   protocol = "HTTP"
#   vpc_id   = aws_vpc.three_tier_infra_app_vpc.id
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.three_tier_infra_app_api_tg.arn
#   }
# }

# # --- API app Autoscaling Group ---
# resource "aws_autoscaling_group" "api_app_asg" {
#   name                      = "three-tier-infra-api-app-asg"
#   max_size                  = 3
#   min_size                  = 2
#   desired_capacity          = 2

#   launch_template {
#     id      = aws_launch_template.api_app_lt.id
#     version = "$Latest"
#   }
...
#     aws_subnet.three_tier_infra_app_subnet_private_1.id,
#     aws_subnet.three_tier_infra_app_subnet_private_2.id,
#     aws_subnet.three_tier_infra_app_subnet_private_3.id,
#   ]

#   target_group_arns = [aws_lb_target_group.three_tier_infra_app_api_tg.arn]
...
#   tag {
#     key                 = "Name"
#     value               = "three-tier-infra-api-app-asg-instance"
#     propagate_at_launch = true
#   }
# }
